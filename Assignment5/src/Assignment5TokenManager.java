         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 3:
                  ...
                  break;
               case 23:
                  if ((0xfc00ffe600000000L & l) != 0L && kind > 4)
                     kind = 4;
                  break;
               case 24:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 22:
                  ...
                  break;
               case 23:
                  if ((0x7800000068000001L & l) != 0L && kind > 4)
                     kind = 4;
                  break;
               case 29:
                  if (curChar == 94)
...
static final int[] jjnextStates = {
   264, 266, 267, 269, 42, 24, 43, 39, 24, 40, 253, 254, 256, 242, 248, 226, 
   230, 235, 238, 239, 205, 208, 210, 213, 216, 222, 194, 197, 202, 185, 189, 191, 
   160, 164, 168, 175, 177, 179, 128, 137, 141, 149, 150, 157, 103, 106, 110, 117, 
   121, 126, 74, 79, 87, 92, 64, 4, 68, 54, 58, 
};
...
static private final int[] jjrounds = new int[270];
static private final int[] jjstateSet = new int[540];
...
protected static final int[][][] statesForState = {
 {
   { 0, 1, 7, 13, 17, 22, 23, 25, 26, 27, 28, 29, 31, 32, 34, 36, 38, 41, 44, 45, 47, 59, 69, 93, 127, 158, 180, 192, 203, 223, 240, 249, 257, 260, 263, },
   { 0, 1, 7, 13, 17, 22, 23, 25, 26, 27, 28, 29, 31, 32, 34, 36, 38, 41, 44, 45, 47, 59, 69, 93, 127, 158, 180, 192, 203, 223, 240, 249, 257, 260, 263, },
   { 2 },
   { 3 },
   { 4 },
